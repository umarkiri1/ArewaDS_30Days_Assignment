...
student = dict()
student.update({'first_name': 'Umar', 'last_name': 'Aliyu','gender': 'male','age': 30,'marital_status': 'Married','skills':['MySQL','PowerBI','Python'], 'country':'Nigeria','city': 'Jigawa','address': 'Taura'})
